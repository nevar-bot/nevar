...
export default class GiveawaysManager {
    ...
    public async createGiveaway(giveawayData: any): Promise<typeof Giveaway|Error> {
        ...
        await giveaway.save().catch((err: Error): Error => { return err });
        return giveaway;
    }
    ...
    public async deleteGiveaway(giveawayId: string): Promise<boolean> {
        ...
        /* Delete giveaway */
        await Giveaway.findOneAndDelete({ messageId: giveawayId }).catch((err: Error): boolean => { return false });
        ...
        if(guild && channel && message){
            const endEmbed: EmbedBuilder = new EmbedBuilder()
                .setDescription(
                    "## " + this.client.emotes.gift + " " + giveaway.prize + "\n\n" +
                    "### " + this.client.emotes.arrow + " Es sind keine weiteren Teilnahmen möglich!\n\n" +
                    "### " + this.client.emotes.information + " Informationen\n" +
                    this.client.emotes.error + " Das Gewinnspiel wurde vorzeitig vom Ersteller beendet, ohne einen Gewinner zu ziehen."
                )
                .setThumbnail(this.client.user!.displayAvatarURL())
                .setColor(this.client.config.embeds["ERROR_COLOR"]);

            const participateButton: ButtonBuilder = this.client.createButton("giveaway_participate", "\u200b", "Primary", this.client.emotes.tada, true);
    ...
    public async endGiveaway(giveawayId: string): Promise<boolean|Object> {
        ...
        await giveaway.save().catch((err: Error): boolean => { return false });
    ...
    public async rerollGiveaway(giveawayId: string): Promise<boolean|Object> {
        ...
        /* Get new winners */
        const entrantIds: string[] = giveaway.entrantIds.filter((entrantId: string): boolean => !giveaway.exemptMembers.includes(entrantId) && !giveaway.winnerIds.includes(entrantId));
    ...
    private async sendMainEmbed(giveaway: any): Promise<any> {
        ...
        const embed: EmbedBuilder = new EmbedBuilder()
            .setDescription(
                "## " + this.client.emotes.gift + " " + giveaway.prize + "\n\n" +
                "### " + this.client.emotes.arrow + " Um teilzunehmen, drücke den " + this.client.emotes.tada + " Button!\n\n" +
                this.client.emotes.calendar + " Endet am " + this.client.utils.getDiscordTimestamp(giveaway.endAt, "f") + "\n" +
                this.client.emotes.reminder + " Endet " + this.client.utils.getDiscordTimestamp(giveaway.endAt, "R") + "\n\n" +
                "### " + this.client.emotes.information + " Informationen\n" +
                this.client.emotes.heart + " Veranstaltet von " + hoster.toString() + "\n" +
                this.client.emotes.tada + " **" + giveaway.winnerCount + "** Gewinner/-innen\n" +
                this.client.emotes.users + " **" + giveaway.entrantIds.length + "** Teilnehmer/-innen\n\n" +
                "### " + this.client.emotes.rocket + " Teilnahmebedingungen\n" +
        ...
        if(giveaway.messageId){
            ...
            /* Send new message */
            const giveawayMessage: any = await channel.send({ content: messageText, embeds: [embed], components: [buttonRow] }).catch((): null => null);
        ...
        if(winners.length >= 1){
            ...
            const giveawayEndEmbed: EmbedBuilder = new EmbedBuilder()
                .setDescription(
                    "## " + this.client.emotes.gift + " " + giveaway.prize + "\n\n" +
                    "### " + this.client.emotes.arrow + " Es sind keine weiteren Teilnahmen möglich!\n\n" +
                    this.client.emotes.calendar + " Endete am " + this.client.utils.getDiscordTimestamp(giveaway.endAt, "f") + "\n" +
                    this.client.emotes.reminder + " Endete " + this.client.utils.getDiscordTimestamp(giveaway.endAt, "R") + "\n\n" +
                    "### " + this.client.emotes.information + " Informationen\n" +
                    this.client.emotes.heart + " Veranstaltet von " + hoster.toString() + "\n" +
                    this.client.emotes.tada + " **" + giveaway.winnerCount + "** Gewinner/-innen\n" +
                    this.client.emotes.users + " **" + giveaway.entrantIds.length + "** Teilnehmer/-innen\n\n" +
                    "### " + this.client.emotes.tada + " Gewinner/-innen\n" +
                    this.client.emotes.arrow + " " + winners.join(", ")
                )
                .setThumbnail(this.client.user!.displayAvatarURL())
                .setColor(this.client.config.embeds["ERROR_COLOR"])
            ...
            const giveawayEndEmbed: EmbedBuilder = new EmbedBuilder()
                .setDescription(
                    ...
                    this.client.emotes.users + " **" + giveaway.entrantIds.length + "** Teilnehmer/-innen\n\n" +
                    "### " + this.client.emotes.tada + " Gewinner/-innen\n" +
                    this.client.emotes.arrow + " Es gibt keine Gewinner/-innen, da es keine Teilnahmen gab."
                )
                .setThumbnail(this.client.user!.displayAvatarURL())
                .setColor(this.client.config.embeds["ERROR_COLOR"])
