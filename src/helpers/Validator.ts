...
export default class Validator {
    static configValidator(): void {
        ...
        if(!config.apikeys["DBL"]) Logger.warn("TOML: apikeys.DBL is empty. Posting stats to discordbotlist.com and receiving votes won't work");
        if(!config.apikeys["DBL_WEBHOOK_AUTH"]) Logger.warn("TOML: apikeys.DBL_WEBHOOK_AUTH is empty. Receiving votes from discordbotlist.com won't work");
