...
export default class CreditsCommand extends BaseCommand
{
	...
	private async showCredits()
	{
		...
		const credits: string =
			"## HTTP-Anfragen\n" +
			this.client.emotes.arrow + " [axios](https://npmjs.com/package/axios) - HTTP Anfragen\n" +
			"## Express und Middleware\n" +
			this.client.emotes.arrow + " [express](https://npmjs.com/package/express) - Web-Framework\n" +
			this.client.emotes.arrow + " [body-parser](https://npmjs.com/package/body-parser) - Parsing von HTTP Requests\n" +
			this.client.emotes.arrow + " [cors](https://npmjs.com/package/cors) - Cross-Origin Resource Sharing Middleware\n" +
			this.client.emotes.arrow + " [helmet](https://npmjs.com/package/helmet) - HTTP-Header-Sicherheits-Middleware\n" +
			"## Datenbank\n" +
			this.client.emotes.arrow + " [mongoose](https://npmjs.com/package/mongoose) - MongoDB ODM\n" +
			"## Discord\n" +
			...
			this.client.emotes.arrow + " [@top-gg/sdk](https://www.npmjs.com/package/@top-gg/sdk) - Vote Webhook TOP.GG\n" +
			this.client.emotes.arrow + " [topgg-autoposter](https://www.npmjs.com/package/topgg-autoposter) - TOP.GG Bot-Statistiken"
		"## Bildverarbeitung und -manipulation\n" +
			this.client.emotes.arrow + " [blablacord](https://npmjs.com/package/canvacord) - Bildmanipulation für Discord\n" +
			this.client.emotes.arrow + " [jimp](https://npmjs.com/package/jimp) - Bildverarbeitung\n" +
			"## Zeit- und Zeitzonen-Handling\n" +
			this.client.emotes.arrow + " [moment](https://npmjs.com/package/moment) - Datums- und Zeitmanipulation\n" +
			this.client.emotes.arrow + " [moment-timezone](https://npmjs.com/package/moment-timezone) - Zeitzonen-Unterstützung für moment\n" +
			this.client.emotes.arrow + " [enhanced-ms](https://npmjs.com/package/enhanced-ms) - Zeitkonvertierung\n" +
			this.client.emotes.arrow + " [node-schedule](https://npmjs.com/package/node-schedule) - Cronjobs\n" +
			"## Mathematische Berechnungen\n" +
			this.client.emotes.arrow + " [mathjs](https://npmjs.com/package/mathjs) - Mathematische Berechnungen\n" +
			"## Sonstiges\n" +
			this.client.emotes.arrow + " [chalk](https://npmjs.com/package/chalk) - Terminaltext-Styling\n" +
			...
			this.client.emotes.arrow + " [typescript-formatter](https://npmjs.com/package/typescript-formatter) - Formatter für TypeScript-Code\n" +
