...
export default class TimestampCommand extends BaseCommand {
	public constructor(client: BaseClient) {
		super(client, {
			name: "timestamp",
			description: "Creates a Discord timestamp from a date",
			localizedDescriptions: {
				de: "Erstellt einen Discord-Timestamp aus einem Datum",
			},
			cooldown: 1000,
			dirname: __dirname,
			slashCommand: {
					...
					.addStringOption((option: any) =>
						option
							...
							.setDescriptionLocalizations({
								de: "Gib hier das Datum im deutschen Format an (Datum & Zeit, nur Datum oder nur Zeit)"
							})
							.setRequired(true),
					)
					.addStringOption((option: any) =>
						option
							...
							.setDescriptionLocalizations({
								de: "Wähle, wie der Timestamp angezeigt werden soll"
							})
							.setRequired(true)
							.addChoices(
								{
								...
								},
								{
									...
									name_localizations: {
										de: "Kurzes Datum (bspw. 28.11.2024)",
									},
									value: "d",
								},
								{
									...
									name_localizations: {
										de: "Langes Datum (bspw. 28. November 2024)",
									},
									value: "D",
								},
								{
									...
									name_localizations: {
										de: "Kurzes Datum und kurze Zeit (bspw. 28. November 2024 09:01)",
									},
									value: "f",
								},
								{
									...
									name_localizations: {
										de: "Langes Datum und lange Zeit (bspw. Donnerstag, 28. November 2024 09:01)",
									},
									value: "F",
								},
								{
									...
									name_localizations: {
										de: "Relative Zeit (bspw. vor 3 Jahren)",
									},
									value: "R",
								},
							),
	...
	private async createTimestamp(date: string, type: string): Promise<any> {
		...
		const timestampEmbed: EmbedBuilder = this.client.createEmbed(
			this.translate("generated", { e: this.client.emotes, timestamp, rawTimestamp}),
			"success",
			"normal"
		);
