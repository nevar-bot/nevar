...
export default class
{
    ...
    public async dispatch(oldChannel: any, newChannel: any): Promise<any>
    {
        ...
        if(oldChannel.topic !== newChannel.topic) properties.push(this.client.emotes.quotes + " Thema: ~~" + (oldChannel.topic ? oldChannel.topic : "Kein Thema") + "~~ **" + (newChannel.topic ? newChannel.topic : "Kein Thema") + "**");
        ...
        if(oldChannel.rateLimitPerUser !== newChannel.rateLimitPerUser) properties.push(this.client.emotes.timeout + " Slow-Modus: ~~" + (oldChannel.rateLimitPerUser ? oldChannel.rateLimitPerUser + " Sekunde(n)" : "Kein Limit") + "~~ **" + (newChannel.rateLimitPerUser ? newChannel.rateLimitPerUser + " Sekunde(n)" : "Kein Limit") + "**");
